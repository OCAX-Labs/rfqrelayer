...
func NewTable(db rfqdb.Database, prefix string) rfqdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) rfqdb.Iterator {
...
func (t *table) NewBatch() rfqdb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) rfqdb.Batch {
...
func (t *table) NewSnapshot() (rfqdb.Snapshot, error) {
...
func (b *tableBatch) Replay(w rfqdb.KeyValueWriter) error {
